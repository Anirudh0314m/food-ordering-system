...
const handleLogin = async (email, password) => {
  try {
    ...
    // Get users from localStorage or create if it doesn't exist
    ...
    if (storedUsers) {
      ...
      // Create some default users if no users exist yet
      users = [
        {
          id: '1',
          name: 'Demo User',
    ...
    if (user.password !== password) { // In real app, use bcrypt.compare
    ...
    localStorage.setItem('userEmail', email); // Store the email too
    navigate('/dashboard');
